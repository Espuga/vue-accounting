...
<template>
   <div class="flex flex-column" >
    <div class="grid">
      <!-- SELECTORS -->
      <div class="col-12">
        <div class="col-12 ml-1 grid bg-white border-round-xl justify-content-center gap-3">
        ...
        <Panel header="Header" ref="cardGridFi" :collapsed="false" :pt="{
          ...
          <template #header>
            <div class="flex align-items-center">
              ...
              <span class="text-lg ml-2"> {{ group.data.value.name }}'s members </span>
            </div>
          </template>
          <!-- CHART -->
        ...
        <Panel header="Header" ref="cardGridFi" :collapsed="false" :pt="{
          ...
          <template #header>
            <div class="flex align-items-center">
              ...
              <span class="text-lg ml-2"> {{ group.data.value.name }}'s projects </span>
            </div>
          </template>
          <!-- TABLE -->
          ...
          tableStyle="min-width: 20rem" class="p-datatable-sm" removableSort > 
            ...
            <Column v-if="teacher" style="width: 3%" bodyStyle="text-align:center">
              <template #body="{ data }">
                <a href="#" @click="deleteProject(data.id)">
      ...
      <Dialog v-model:visible="userVisible" maximizable modal header="User Information" :style="{ width: '80rem' }" :breakpoints="{ '1199px': '75vw', '575px': '90vw' }">
        ...
        <div class="grid">
          ...
          <!-- USER CHART -->
          <div class="col-6">
            <div class="responsive" style="height: 50vh; clientHeight: 50vh">
      ...
      :breakpoints="{ '1199px': '75vw', '575px': '90vw' } ">
        ...
        <template #footer>
          <div class="flex justify-content-center w-full gap-3">
            ...
            <Button label="Save" icon="pi pi-save" @click="submitProject" class="bg-green-600 border-green-700"/>
          </div>
        </template>
      </Dialog>
